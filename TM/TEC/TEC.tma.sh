...
sed -e 's/@PARTNO@/2/; s/@CHANNEL@/LPV/g; s/@DESC@/Laser Pressure Vessel TEC/; s/@IDLE@//' TEC0.tma >>TEC.tma
...
sed -e 's/@PARTNO@/5/; s/@CHANNEL@/Cell/g; s/@DESC@/Cell TEC/; s/@IDLE@//' TEC0.tma >>TEC.tma
sed -e 's/@PARTNO@/6/; s/@CHANNEL@/DPV/g; s/@DESC@/Detector Pressure Vessel TEC/; s/@IDLE@//' TEC0.tma >>TEC.tma
